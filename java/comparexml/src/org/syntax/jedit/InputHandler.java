 ...
 * 
 * @author Slava Pestov
 * @version $Id: InputHandler.java,v 1.2 2003/01/26 23:36:20 rohanr2 Exp $
...
public abstract class InputHandler extends KeyAdapter
{
	...
	public static final ActionListener CLIP_CUT = new clip_cut();
        ...
        //public static final ActionListener UNDO = new com.robrohan.editorkit.XMLEditorPane.undoAction();
		...
		public void actionPerformed(ActionEvent evt)
		{
			...
			if(!textArea.isEditable())
			{
				...
				return;
                        ...
                        ////////////////////////////////////////////////////////
                        // r2: add auto indent 2003.12.26
                        String indenttext = "";
                        try{
                            String indentAmount =  textArea.getLineText(textArea.getCaretLine());
                            //prolly a better way to do this...
                            org.apache.regexp.RE r = new org.apache.regexp.RE("^[^\\<\\>a-zA-Z0-9\\-\\+%\\$#@\\!\\(\\);'\":\\.,&\\^_=\\?\\\\|\\`\\~]+");
                            r.match(indentAmount);

                            if(r.getParen(0) != null){
                                indenttext = r.getParen(0);
                            }
                        }catch(Exception e){
                            System.err.println("Autoindent Error: " + e.toString());
                        }
	...
	public static class next_line implements ActionListener
	{
		...
		public void actionPerformed(ActionEvent evt)
		{
			...
			textArea.setMagicCaretPosition(magic);
                        ...
                        //if counting tabs clear them here?
		}
	}
